...
LLVM_ABI LLVM_ATTRIBUTE_RETURNS_NONNULL LLVM_ATTRIBUTE_RETURNS_NOALIAS UE_CPP_BRIDGE_API void *
...
LLVM_ABI UE_CPP_BRIDGE_API void deallocate_buffer(void *Ptr, size_t Size, size_t Alignment);
