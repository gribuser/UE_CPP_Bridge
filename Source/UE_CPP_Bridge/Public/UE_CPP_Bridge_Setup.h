...
/// 2 - UE implementation (TArray, FCriticalSection, etc)
	...
	#if UE_BUILD_DEBUG + UE_BUILD_DEVELOPMENT + UE_BUILD_TEST + UE_BUILD_SHIPPING == 1 && !defined(P2P_BUILD_FOR_STANDALONE_SERVER)
	...
	#define UE_CPP_BRIDGE_CONTAINER_CLASSES_MODE 2
#endif

#ifndef UE_CPP_BRIDGE_TDENSEMAP
	#define UE_CPP_BRIDGE_TDENSEMAP 1
#endif
...
#endif // P2P_BUILD_FOR_STANDALONE_SERVER
